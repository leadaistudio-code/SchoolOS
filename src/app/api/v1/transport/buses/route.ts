...
import { busSchema, listBuses, saveBus } from '@/server/modules/transport/service'
...
export const POST = route(
  async (req: NextRequest, ctx) => ok(await saveBus(ctx, busSchema.parse(await req.json())), undefined, { status: 201 }),
