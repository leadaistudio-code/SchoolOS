...
export const ONBOARDING_SHEETS: OnboardingSheet[] = [
  {
    ...
    rows: [
      ...
      ['5', 'Add Parents. Use the student admission number to link. One row per parent — full name in Parent name.'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['Guardian relation', 'Optional — parent and guardian are treated the same (defaults to Guardian)'],
  ...
  {
    name: 'Parents',
    purpose: 'Parents linked to students',
    headers: [
