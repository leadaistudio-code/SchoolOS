...
export const SYSTEM_ROLES: RoleDef[] = [
  ...
  },
  {
    key: ROLE.TEACHER,
    name: 'Teacher',
    description: 'Teaches assigned classes; marks attendance and enters marks.',
    permissions: [
      'dashboard.view',
      'students.view',
      'parents.view',
      ...
      'questionbank.view', 'questionbank.create', 'questionbank.edit', 'questionbank.delete',
      ...
      'feedback.view', 'feedback.teacher_view_own', 'feedback.teacher_give_student', 'feedback.submit',
      'teacher_refresh.view_self', 'teacher_refresh.take',
      'library.view',
      'events.view',
      'documents.view',
      'reports.view',
